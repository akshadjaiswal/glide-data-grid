...
export function SortMenu({ columnId, current, onChange }: SortMenuProps) {
  ...
  return (
    <div className="w-48 rounded-xl border border-slate-200 bg-white p-2 text-sm shadow-xl shadow-slate-900/10">
      <button
        type="button"
        className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 ${
      ...
      <button
        type="button"
        className={`mt-1 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 ${
      ...
      <button
        type="button"
        className="mt-2 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-slate-600 hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
